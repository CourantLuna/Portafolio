...
export default function App() {
  return (
<div className=" relative min-h-screen w-full bg-gradient-to-br dark:bg-dark from-pink-100 via-violet-50 to-blue-50">
      <AppBar />
<div className="min-h-screen w-full flex flex-col lg:flex-row justify-center bg-gradient-to-br bg-dark from-pink-100 via-violet-50 to-blue-50 lg:p-4">
